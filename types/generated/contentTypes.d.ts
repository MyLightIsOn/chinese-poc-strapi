...
export interface ApiExerciseExercise extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['fill_in_blank', 'reorder', 'multiple_choice']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_response: Schema.Attribute.JSON;
    users_permissions_user: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    vocab_sets: Schema.Attribute.Relation<
      'manyToMany',
      'api::vocab-set.vocab-set'
    >;
  };
}
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    english: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::story.story'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    simplified: Schema.Attribute.Text;
    topic: Schema.Attribute.String;
    traditional: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
...
export interface ApiVocabEntryVocabEntry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vocab-entry.vocab-entry'
    > &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Text;
    pinyin: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    simplified: Schema.Attribute.String;
    traditiional: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    vocab_set: Schema.Attribute.Relation<
      'manyToOne',
      'api::vocab-set.vocab-set'
    >;
  };
...
export interface ApiVocabSetVocabSet extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::vocab-entry.vocab-entry': ApiVocabEntryVocabEntry;
      'api::vocab-set.vocab-set': ApiVocabSetVocabSet;
